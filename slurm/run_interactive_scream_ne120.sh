...
#   2. Run this script:
#      bash /global/homes/f/feng045/program/waccem/gsrm_cooccurrencefeature/slurm/run_interactive_scream_ne120.sh

echo "=========================================="
echo "Starting sequential task execution for scream_ne120"
echo "=========================================="
echo ""
...
while IFS= read -r line; do
    ...
    echo "End time: $(date)"
    echo ""
done < /global/homes/f/feng045/program/waccem/gsrm_cooccurrencefeature/slurm/tasks_all_scream_ne120.txt
