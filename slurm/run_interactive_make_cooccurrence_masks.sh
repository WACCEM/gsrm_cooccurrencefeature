...
#   2. Run this script:
#      bash /global/homes/f/feng045/program/waccem/gsrm_cooccurrencefeature/slurm/run_interactive_make_cooccurrence_masks.sh

echo "=========================================="
echo "Starting sequential task execution for make_cooccurrence_masks"
echo "=========================================="
echo ""
