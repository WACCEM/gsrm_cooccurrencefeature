...
LINE=$(sed -n "$SLURM_ARRAY_TASK_ID"p /global/homes/f/feng045/program/waccem/gsrm_cooccurrencefeature/slurm/tasks_make_mcs_swath_masks.txt)
echo $LINE
