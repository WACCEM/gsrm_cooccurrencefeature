...
##SBATCH --mem=8G
#SBATCH -t 01:00:00
#SBATCH -J um_glm_n2560_RAL3p3
#SBATCH -A m1867
#SBATCH --array=0-4%5
#SBATCH --output=logs/extract_etc_UM_%A_%a.log
...
#   sbatch --array=0-4%3 slurm_extract_etc_vars_UM.sh
# To restart failed tasks: 
#   sbatch --array=2,4 slurm_extract_etc_vars_UM.sh
# ================================
